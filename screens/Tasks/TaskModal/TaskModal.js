            ...
            <View style={styles.body_container} key={item.key}>
                <View style={[styles.form_container,{borderRadius:10,shadowOffset:{width:0,height:1},shadowColor:"#99CCC0",shadowOpacity:1.5}]}>
                    ...
                    <View style={{ flexDirection: "row", justifyContent: "flex-start", marginTop: 30 }}>
                        <View>
                            <Text style={{fontWeight:"bold"}}>Working Percent:</Text>
                        </View>
                        <View style={{ flexDirection: "row", height: 25, marginLeft: 5, marginTop: -6 }}>
                 
                            <TouchableOpacity style={styles.minus_btn} color={COLORS.darkBlue}  onPress={decrease} ><Text style={{color:COLORS.white,padding:3,fontSize:20,marginTop:-7}}>-</Text></TouchableOpacity>
