                    ...
                    <View
                        ...
                        <View
                            ...
                            <View
                                ...
                                <Text style={{ ...FONTS.body2, color: COLORS.darkGray }}>Quantity item</Text>
            ...
            <>
                <View
                    ...
                    <View>
                        ...
                        <Divider style={{ backgroundColor: COLORS.black, width: SIZES.width * 0.90, marginHorizontal: 2, top: 5 }} />
    ...
    return (
        <View>
            <View>
                ...
                <Pressable
                    ...
                    <View style={{ alignItems: "center", alignSelf: "center" }}>
                        <Text onPress={() => setQuantity(!quant_ity)} style={[FONTS.h3, { color: COLORS.darkGray }]}>Quantity</Text>
                    </View>
                    <View style={{ alignItems: "center", alignSelf: "center" }}>
            ...
            <View style={{ top: 22 }}>
                {quant_ity ?
                    <>
                        <View style={{ borderWidth: 1, backgroundColor: COLORS.lightGray2, borderColor: COLORS.lightblue_200 }}>
                            <View>
                                <View
                                    style={{
                                        justifyContent: 'center',
                                    ...
                                    <Text style={{ ...FONTS.h3, color: COLORS.darkGray }}>Daily Quantity Report</Text>
                                    <Divider style={{ backgroundColor: COLORS.black, width: SIZES.width * 0.90, marginHorizontal: 2, top: 5 }} />
