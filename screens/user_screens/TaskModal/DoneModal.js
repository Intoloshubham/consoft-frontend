    ...
    const renderItem = ({ item }) => (
        <View style={{ backgroundColor: COLORS.gray3, padding: SIZES.base, borderRadius: 10, margin: 5 }}>
            ...
            >
                ...
                <View>
                    {
                        (item.id == 1) ? <Text style={{ fontWeight: "bold", color: COLORS.blue }}>{item.name}
                        </Text> : (item.id == 2) ? <Text style={{ fontWeight: "bold", color: COLORS.red }}>{item.name}
                        </Text> : <Text style={{ fontWeight: "bold", color: COLORS.black }}>{item.name}
                        </Text>
                    }
