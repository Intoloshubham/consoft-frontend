...
import { FormInput, HeaderBar, TextButton, DeleteConfirmationToast, CustomToast } from '../../../Components';
...
const QuantityItem = () => {
                    ...
                    <View
                        ...
                        <ScrollView>
                            <View
                                ...
                                <Text style={{ fontSize: 20, fontWeight: 'bold' }}>Quantity Items</Text>
                                <Modal
                                    animationType="slide"
                                    transparent={false}
                                    visible={unitmodal}>
    ...
    return (
        <View>
            <HeaderBar right={true} title="quantityItems" />
            <TextButton
                label="Add New"
                buttonContainerStyle={{
                    height: 45,
